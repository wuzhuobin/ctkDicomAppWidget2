...
public:
  explicit ctkDICOMDatabase2(QObject *parent = 0);
  explicit ctkDICOMDatabase2(QString databaseFile);
  virtual ~ctkDICOMDatabase2();
...
protected:
  QScopedPointer<ctkDICOMDatabase2Private> d_ptr;



private:
  Q_DECLARE_PRIVATE(ctkDICOMDatabase2);
  Q_DISABLE_COPY(ctkDICOMDatabase2);
};
