...
{
  Q_DECLARE_PUBLIC(ctkDICOMDatabase2);
protected:
  ctkDICOMDatabase2* const q_ptr;

public:
  ctkDICOMDatabase2Private(ctkDICOMDatabase2&);
  ~ctkDICOMDatabase2Private();
...
//------------------------------------------------------------------------------
// ctkDICOMDatabase2Private methods

//------------------------------------------------------------------------------
ctkDICOMDatabase2Private::ctkDICOMDatabase2Private(ctkDICOMDatabase2& o): q_ptr(&o)
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::resetLastInsertedValues()
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::init(QString databaseFilename)
{
  Q_Q(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::registerCompressionLibraries(){
...
//------------------------------------------------------------------------------
ctkDICOMDatabase2Private::~ctkDICOMDatabase2Private()
{
}

//------------------------------------------------------------------------------
bool ctkDICOMDatabase2Private::loggedExec(QSqlQuery& query)
{
  return (loggedExec(query, QString("")));
}

//------------------------------------------------------------------------------
bool ctkDICOMDatabase2Private::loggedExec(QSqlQuery& query, const QString& queryString)
{
  bool success;
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2Private::loggedExecBatch(QSqlQuery& query)
{
  bool success;
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::beginTransaction()
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::endTransaction()
{
  QSqlQuery transaction( this->Database );
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::createBackupFileList()
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::removeBackupFileList()
{
  QSqlQuery query(this->Database);
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2::openDatabase(const QString databaseFile, const QString& connectionName )
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
// ctkDICOMDatabase2 methods

//------------------------------------------------------------------------------
ctkDICOMDatabase2::ctkDICOMDatabase2(QString databaseFile)
  : d_ptr(new ctkDICOMDatabase2Private(*this))
{
  Q_D(ctkDICOMDatabase2);
...
ctkDICOMDatabase2::ctkDICOMDatabase2(QObject* parent)
  : d_ptr(new ctkDICOMDatabase2Private(*this))
{
  Q_UNUSED(parent);
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
ctkDICOMDatabase2::~ctkDICOMDatabase2()
{
}
...
//------------------------------------------------------------------------------
const QString ctkDICOMDatabase2::lastError() const {
  Q_D(const ctkDICOMDatabase2);
  return d->LastError;
}

//------------------------------------------------------------------------------
const QString ctkDICOMDatabase2::databaseFilename() const {
  Q_D(const ctkDICOMDatabase2);
  return d->DatabaseFileName;
}

//------------------------------------------------------------------------------
const QString ctkDICOMDatabase2::databaseDirectory() const {
...
//------------------------------------------------------------------------------
const QSqlDatabase& ctkDICOMDatabase2::database() const {
  Q_D(const ctkDICOMDatabase2);
  return d->Database;
}

//------------------------------------------------------------------------------
void ctkDICOMDatabase2::setThumbnailGenerator(ctkDICOMAbstractThumbnailGenerator *generator){
  Q_D(ctkDICOMDatabase2);
  d->thumbnailGenerator = generator;
}

//------------------------------------------------------------------------------
ctkDICOMAbstractThumbnailGenerator* ctkDICOMDatabase2::thumbnailGenerator(){
  Q_D(const ctkDICOMDatabase2);
  return d->thumbnailGenerator;
}

//------------------------------------------------------------------------------
bool ctkDICOMDatabase2Private::executeScript(const QString script) {
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2Private::filenames(QString table)
{
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::initializeDatabase(const char* sqlFileName)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::schemaVersionLoaded()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::schemaVersion()
{
  ...
  //   so that the ctkDICOMDatabase2Private::filenames method
  //   still works.
  //
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::updateSchemaIfNeeded(const char* schemaFile)
{
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::updateSchema(const char* schemaFile)
{
  // backup filelist
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2::closeDatabase()
{
  Q_D(ctkDICOMDatabase2);
  d->Database.close();
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::patients()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::studiesForPatient(QString dbPatientID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::studyForSeries(QString seriesUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::patientForStudy(QString studyUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QHash<QString,QString> ctkDICOMDatabase2::descriptionsForFile(QString fileName)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::descriptionForSeries(const QString seriesUID)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::descriptionForStudy(const QString studyUID)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::nameForPatient(const QString patientUID)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::seriesForStudy(QString studyUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::instancesForSeries(const QString seriesUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::filesForSeries(QString seriesUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::fileForInstance(QString sopInstanceUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::seriesForFile(QString fileName)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::instanceForFile(QString fileName)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QDateTime ctkDICOMDatabase2::insertDateTimeForInstance(QString sopInstanceUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::allFiles()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2::loadInstanceHeader (QString sopInstanceUID)
{
  Q_D(ctkDICOMDatabase2);
  QSqlQuery query(d->Database);
  query.prepare ( "SELECT Filename FROM Images WHERE SOPInstanceUID=?");
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2::loadFileHeader (QString fileName)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QStringList ctkDICOMDatabase2::headerKeys ()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::headerValue (QString key)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::instanceValue(QString sopInstanceUID, QString tag)
{
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::instanceValue(const QString sopInstanceUID, const unsigned short group, const unsigned short element)
{
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::fileValue(const QString fileName, QString tag)
{
  unsigned short group, element;
  this->tagToGroupElement(tag, group, element);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::fileValue(const QString fileName, const unsigned short group, const unsigned short element)
{
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::tagToGroupElement(const QString tag, unsigned short& group, unsigned short& element)
{
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::groupElementToTag(const unsigned short& group, const unsigned short& element)
{
...
//------------------------------------------------------------------------------
int ctkDICOMDatabase2Private::insertPatient(const ctkDICOMItem& ctkDataset)
{
  int dbPatientID;
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::insertStudy(const ctkDICOMItem& ctkDataset, int dbPatientID)
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::insertSeries(const ctkDICOMItem& ctkDataset, QString studyInstanceUID)
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2::setTagsToPrecache( const QStringList tags)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
const QStringList ctkDICOMDatabase2::tagsToPrecache()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2Private::openTagCacheDatabase()
{
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::precacheTags( const QString sopInstanceUID )
{
  Q_Q(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
void ctkDICOMDatabase2Private::insert( const ctkDICOMItem& ctkDataset, const QString& filePath, bool storeFile, bool generateThumbnail)
{
  Q_Q(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::fileExistsAndUpToDate(const QString& filePath)
{
  Q_D(ctkDICOMDatabase2);
  bool result(false);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::isOpen() const
{
  Q_D(const ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::isInMemory() const
{
  Q_D(const ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::removeSeries(const QString& seriesInstanceUID)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::cleanup()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::removeStudy(const QString& studyInstanceUID)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::removePatient(const QString& patientID)
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::tagCacheExists()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::initializeTagCache()
{
  Q_D(ctkDICOMDatabase2);
...
//------------------------------------------------------------------------------
QString ctkDICOMDatabase2::cachedTag(const QString sopInstanceUID, const QString tag)
{
  Q_D(ctkDICOMDatabase2);
  if ( !this->tagCacheExists() )
    {
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::cacheTag(const QString sopInstanceUID, const QString tag, const QString value)
{
  QStringList sopInstanceUIDs, tags, values;
  sopInstanceUIDs << sopInstanceUID;
  tags << tag;
...
//------------------------------------------------------------------------------
bool ctkDICOMDatabase2::cacheTags(const QStringList sopInstanceUIDs, const QStringList tags, QStringList values)
{
  Q_D(ctkDICOMDatabase2);
  if ( !this->tagCacheExists() )
    {
